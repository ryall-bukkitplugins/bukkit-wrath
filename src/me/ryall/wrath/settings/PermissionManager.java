...
public class PermissionManager
{
    ...
    {
        return _player == null || (permissions == null && _player.isOp()) || hasPermission(_player, PERMISSIONS_PREFIX + "*") || hasPermission(_player, "*");
    }

    public boolean hasDrownPermission(Player _player)
    {
        return hasGlobalPermission(_player) || hasPermission(_player, PERMISSIONS_PREFIX + "drown");
    }

    public boolean hasExplodePermission(Player _player)
    {
        return hasGlobalPermission(_player) || hasPermission(_player, PERMISSIONS_PREFIX + "explode");
    }

    public boolean hasIgnitePermission(Player _player)
    {
        return hasGlobalPermission(_player) || hasPermission(_player, PERMISSIONS_PREFIX + "ignite");
    }

    public boolean hasImpalePermission(Player _player)
    {
        return hasGlobalPermission(_player) || hasPermission(_player, PERMISSIONS_PREFIX + "impale");
    }

    public boolean hasRavagePermission(Player _player)
    {
        return hasGlobalPermission(_player) || hasPermission(_player, PERMISSIONS_PREFIX + "ravage");
    }
